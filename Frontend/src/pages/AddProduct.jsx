...
const AddProduct = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 p-6 bg-cyan-500 rounded-lg shadow-lg">
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <button
                ...
                className="mt-2 px-4 py-2 text-white font-semibold rounded-lg bg-blue-500 hover:bg-blue-600 transition-colors"
              >
                Add Color
              </button>
            </div>
