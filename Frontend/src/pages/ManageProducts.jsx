...
const ManageProducts = () => {
  ...
  return (
    <Layout>
      <div
        className="max-w-full mx-auto p-6 rounded-lg shadow-lg"
        style={{ backgroundImage: "url('/manageProducts-bg.jpg')" }}
      >
        <h2 className="text-3xl font-extrabold text-center text-white mb-6 bg-black p-2">
          MANAGE PRODUCTS
        </h2>
