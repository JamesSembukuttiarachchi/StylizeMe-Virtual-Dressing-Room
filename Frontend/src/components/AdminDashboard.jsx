          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 mx-4">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105">
              ...
              <p className="text-gray-600 mb-6">
                You can efficiently manage the catalog of dresses and
                accessories by adding, updating, or removing products. Each item
                you upload will be equipped with AR and 3D models allowing
                customers to virtually try on outfits and accessories in
                real-time.
              </p>
              <button
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105">
              ...
              <p className="text-gray-600 mb-6">
                You can update the size options for various dress brands
                allowing you to assign brand-specific size recommendations for
                different dress types, ensuring customers receive accurate
                sizing information tailored to each brand.
              </p>
              <button
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105">
              ...
              <p className="text-gray-600 mb-6">
                Analyze user interactions based on gender, height, and more.
                This section provides insights into how different user groups
                engage with products, helping you identify trends and optimize
                the virtual try-on experience for specific audiences.
              </p>
              <button
